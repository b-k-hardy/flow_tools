...
from plot_results import plot_seg
...
def skeletonize(segmentation):
    ...
    return X, Y, Z, skel, points, new_points


def main():

    seg = import_segmentation(
        "/Users/bkhardy/Dropbox (University of Michigan)/4D Flow Test Data/Prab 9.27.23/Segmentation.nrrd"
    )

    X, Y, Z, skel, points, new_points = skeletonize(seg)

    plot_seg((X, Y, Z), seg, skel, points, new_points)
